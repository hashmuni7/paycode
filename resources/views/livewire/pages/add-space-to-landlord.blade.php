                                ...
                                <div class="row form-group">  
                                    <div class="col-lg-4">
                                        <div class="form-group @error('rentalPeriod') has-danger @enderror">
                                            <label class="col-form-label" for="rentalPeriod">Monthly License Charge <span class="text-small">(In days)</span></label>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group @error('rentPrice') has-danger @enderror">
                                            <label class="col-form-label" for="rentPrice">Daily License Charge</label>
                                            <input disabled type="number" class="form-control" id="rentPrice" placeholder="" wire:model="rentPrice">
                                            @error('rentPrice')
                                                <div>
                                                    <label class="error">                                          
                                                        <strong>{{ $message }}</strong>
