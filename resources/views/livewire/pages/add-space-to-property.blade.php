        ...
        <div class="container-fluid mb-3">
            <section class="card">
                <header class="card-header card-header-transparent">
                    ...
                    <h2 class="card-title">Add Space To Property </h2>
                    <p class="card-subtitle">Property ID: {{$focusProperty->propertyid}} </p>
                </header>
                <div class="card-body">
                                ...
                                <div class="row form-group">
                                    <div class="col-lg-6">
                                        <div class="form-group">                                           
                                            ...
                                            <button class="btn btn-primary btn-block" type="button" wire:click.prevent="testMethod" style="width: 13em">Add Space</button>
                                        </div>
                                    </div>
