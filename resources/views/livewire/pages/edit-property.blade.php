        ...
        <div class="container-fluid mb-3">
            <section class="card">
                <header class="card-header card-header-transparent">
                    ...
                    <p class="card-subtitle">Property ID: {{$focusProperty->id}}</p>
                </header>
                <div class="card-body">
                    
                    <form wire:submit.prevent="editProperty"  >
                        {{ csrf_field() }}
                        <div class="row">
                                ...
                                <div class="row form-group">
                                    <div class="col-lg-4">
                                        <div class="form-group @error('district') has-danger @enderror">
                                            <label class="col-form-label" for="District">Division</label>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group @error('city') has-danger @enderror">
                                            <label class="col-form-label" for="city">Village</label>
                                ...
                                <div class="row form-group">
                                    <div class="col-lg-6">
                                        <div class="form-group">                                           
                                            <button class="btn btn-primary btn-block" type="submit" style="width: 13em">Update Property</button>
                                        </div>
                                    </div>
