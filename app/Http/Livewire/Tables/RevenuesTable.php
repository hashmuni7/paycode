...
class RevenuesTable extends DataTableComponent
{
    use Figures;
   ...
   // public bool $showSearch = false;
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('KCCA', 'amount')
                ->format(function($value){
                    return $this->ugx(round($value * 0.6));
            }),
            Column::make('Paycode', 'amount')
                ->format(function($value){
                    return $this->ugx(round($value * 0.4));
            })
        ];
    }
