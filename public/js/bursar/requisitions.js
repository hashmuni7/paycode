    ...
    if($('#addRequisitionsForm').valid()) // Test if all Form Fields are validated
        {
            ...
            $.ajax({
                type: "post",
                url: "/bursarhome/finance/requisitions/addrequisition", 
                data: { 
...
function fetchRequisition(requisitionid)
{
    ...
    $.ajax({
        type: "post",
        url: "/bursarhome/finance/requisitions/getrequisitionbyid",
    ...
    if($('#addRequisitionsForm').valid()) // Test if all Form Fields are validated
        {
            ...
            $.ajax({
                type: "post",
                url: "/bursarhome/finance/requisitions/updaterequisition", 
                data: { 
...
function getRequistions()
{
    $.ajax({
        type: "post",
        url: "/bursarhome/finance/requisitions",
        data: {},            
        dataType: "json",
        success: function (response, status, code) {
...
function deleteRequisition(reqid)
{
    $.ajax({
        type: "post",
        url: "/bursarhome/finance/requisitions/deleterequisition",
