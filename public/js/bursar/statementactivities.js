...
$(document).ready(function () {
    ...
    $('#fetchStatementBtn').on('click', function (e) {
        ...
        if(e.detail !== 2)
        {                               
            $('#printActivitiesStatement').addClass('hidden');                       
    ...
    $('#printActivitiesStatement').click(function (e) {

        if(e.detail !== 2)
        {       
                         
            printActivitiesStatement();
        }         
...
function printActivitiesStatement()
{
...
function getActivities(termid)
{
    ...
    $.ajax({
        type: "post",
        url: "/bursarhome/finance/activities/getactivitiesbyterm",
        data: { term_id: termid},
        dataType: "json",
        success: function (response, status, code) {
            ...
            console.log(activityList);
             $('#activities').empty();
             $('#activities').append('<option value="0">All Activities</option>');                                                  
...
function getActivitiesStatement()
{   
    ...
    $.ajax({
        type: "post",
        url: "/bursarhome/finance/activities/statement/getstatement",
        data: {
        ...
        dataType: "json",
        success: function (response, status, code) {
            $('#printActivitiesStatement').removeClass('hidden');
            ...
            $('#balanceHead').html($('#activities :selected').text() + ' Statement');
