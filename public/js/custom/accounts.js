    ...
    if($('#addAccountsForm').valid()) // Test if all Form Fields are validated
        {
            ...
            $.ajax({
                type: "post",
                url: "/adminhome/finance/accounts/addaccount", 
                data: { 
                    account: $('#account').val()
                },
                dataType: "json",
...
function fetchAccount(accountid)
{
    ...
    $.ajax({
        type: "post",
        url: "/adminhome/finance/accounts/getaccountbyid",
...
{   
        ...
        if($('#addAccountsForm').valid()) // Test if all Form Fields are validated
        {
            ...
            $.ajax({
                type: "post",
                url: "/adminhome/finance/accounts/updateaccount",
...
function deleteAccount(accountid, aRow)
{
    ...
    $.ajax({
        type: "post",
        url: "/adminhome/finance/accounts/deleteaccount",
        data: { account_id: accountid},
        dataType: "json",
        success: function (response, status, code) {
            //getSubjects();
