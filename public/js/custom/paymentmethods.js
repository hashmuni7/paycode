    ...
    if($('#addMethodsForm').valid()) // Test if all Form Fields are validated
        {
            ...
            $.ajax({
                type: "post",
                url: "/adminhome/finance/paymentmethods/addmethod", 
                data: { 
                    method: $('#method').val(),
...
function fetchMethod(paymentmethodid)
{
    ...
    $.ajax({
        type: "post",
        url: "/adminhome/finance/paymentmethods/getmethodbyid",
...
{   
        ...
        if($('#addMethodsForm').valid()) // Test if all Form Fields are validated
        {
            ...
            $.ajax({
                type: "post",
                url: "/adminhome/finance/paymentmethods/updatemethod",
...
function deleteMethod(paymentmethodid, aRow)
{
    ...
    $.ajax({
        type: "post",
        url: "/adminhome/finance/paymentmethods/deletemethod",
        data: { payment_method_id: paymentmethodid},
        dataType: "json",
        success: function (response, status, code) {
            //getSubjects();
