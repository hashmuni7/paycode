    ...
    if($('#addActivitysForm').valid()) // Test if all Form Fields are validated
        {
            ...
            $.ajax({
                type: "post",
                url: "/adminhome/finance/activities/addactivity", 
                data: { 
...
function fetchActivity(activityid)
{
    ...
    $.ajax({
        type: "post",
        url: "/adminhome/finance/activities/getactivitybyid",
...
{   
        ...
        if($('#addActivitysForm').valid()) // Test if all Form Fields are validated
        {
            ...
            $.ajax({
                type: "post",
                url: "/adminhome/finance/activities/updateactivity",
                data: { 
...
function deleteActivity(activityid)
{
    ...
    $.ajax({
        type: "post",
        url: "/adminhome/finance/activities/deleteactivity",
        data: { activity_id: activityid},
        dataType: "json",
        success: function (response, status, code) {
            getActivitys();
...
function getActivitys()
{
    $.ajax({
        type: "post",
        url: "/adminhome/finance/activities",
        data: {},            
        dataType: "json",
        success: function (response, status, code) {
