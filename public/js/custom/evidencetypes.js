    ...
    if($('#addEvidencesForm').valid()) // Test if all Form Fields are validated
        {
            ...
            $.ajax({
                type: "post",
                url: "/adminhome/finance/addpaymentevidence", 
                data: { 
...
function fetchEvidenceType(evidenceid)
{
    ...
    $.ajax({
        type: "post",
        url: "/adminhome/finance/getpaymentevidencebyid",
...
{   
        ...
        if($('#addEvidencesForm').valid()) // Test if all Form Fields are validated
        {
            ...
            $.ajax({
                type: "post",
                url: "/adminhome/finance/updatepaymentevidence",
...
function deleteEvidenceType(evidenceid, aRow)
{
    ...
    $.ajax({
        type: "post",
        url: "/adminhome/finance/deletepaymentevidence",
        data: { evidence_id: evidenceid},
        dataType: "json",
        success: function (response, status, code) {            
            notifySuccess(response.data.msg);
