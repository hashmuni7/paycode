...
(function($) {
	...
	*/
	...
	(function() {
		if( $('#flotBars3').get(0) ) {
			var plot = $.plot('#flotBars3', [flotBars3Data], {
				colors: ['#8CC9E8'],
				series: {
					bars: {
						show: true,
	...
	*/
	(function() {
		if( $('#ChartistMultiLineLabels').get(0) ) {
			...
			var $chart = $('#ChartistMultiLineLabels');
	...
	*/
	...
	// 			series: [
	// 				[45, 50, 40, 23, 87, 35, 62, 68, 23, 72, 100, 69],
	// 				[5, 1.2, 2, 7, 2.5, 9, 5, 8, 9, 11, 14, 4]
	// 			]
	// 		};
