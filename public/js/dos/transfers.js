...
function getStreams(classid)
{
    ...
    $.ajax({
        type: "post",
        url: "/doshome/classes/class/getstreamsbyclass",
...
function getPupilsForTransfer()
{
    ...
    $.ajax({
        type: "post",
        url: "/doshome/gradesandacademics/transfers/getpupilsfortransfer",
...
function transferPupils()
{
    ...
    $.ajax({
        type: "post",
        url: "/doshome/gradesandacademics/transfers/transferpupils",
        data: { 
