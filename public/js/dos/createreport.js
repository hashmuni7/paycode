	...
	*/
    ...
    $('#classes').on('change', function () {
        ...
        // ajax request to create a new class to the database
            $.ajax({
                type: "post",
                url: "/doshome/gradesandacademics/reports/getclassexams", 
                data: { 
                    class_id: classid
                },
                dataType: "json",
...
function createReport()
{
     ...
     $.ajax({
        type: "post",
        url: "/doshome/gradesandacademics/reports/createreport", 
        data: { 
...
function goToReports()
{
    //alert('The Test is ready');
     var url = '/orms/public/doshome/gradesandacademics/reports/all';
